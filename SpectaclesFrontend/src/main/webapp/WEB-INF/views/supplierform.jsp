...
<div class="contain">
  ...
  <br />
    ...
    <br />
     <span>
       <form:input class="inputfields" path="supplierEmailId" placeholder="Suppier EmailId" type="text" />
    </span>
    <br />
     <span>
       <form:input class="inputfields" path="supplierAddress" placeholder="Supplier Address" type="text" />
    </span>
    </div>
    <br />
    <div class="submit">
